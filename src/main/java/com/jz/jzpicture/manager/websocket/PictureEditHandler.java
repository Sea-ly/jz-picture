...
import com.jz.jzpicture.manager.websocket.disruptor.PictureEditEventProducer;
import com.jz.jzpicture.manager.websocket.model.PictureEditActionEnum;
import com.jz.jzpicture.manager.websocket.model.PictureEditMessageTypeEnum;
import com.jz.jzpicture.manager.websocket.model.PictureEditRequestMessage;
import com.jz.jzpicture.manager.websocket.model.PictureEditResponseMessage;
...
public class PictureEditHandler extends TextWebSocketHandler {
    ...
    //ps：由于可能同时有多个WebSocket客户端建立连接和发送消息，集合要使用并发包（JUC）中的ConcurrentHashMap来保证线程安全
